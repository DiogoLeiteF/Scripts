...
class Produto:
    def __init__(self, root):
        ...
        self.janela.resizable(0, 0)  # Ativar o redimensionamento da janela(1, 1). <=> para desativar utilizar: (0,0)
    ...
    def db_consulta(self, consulta, parametros=()):
        with sqlite3.connect(self.db) as con:  # iniciamos a coneção com a base de dados
            cursor = con.cursor()  # criar o cursor para operar na base de dados
            resultado = cursor.execute(consulta, parametros)  # preparar a consulta SQL com paramatros, se existirem
            con.commit()  # executar a consulta SQL preparada anteriormente
        return resultado  # Retorna o resultado da consulta

    # metodo para devolver todos os dados da tabela
    def get_produtos(self):

        # primeiro, ao iniciar a app, vamos limpar a tabela se tiver dados residuais ou antigos
    ...
    # implementação do metodo add_produto e as validações de nome e preco
    ...
    def add_produto(self):
        if self.validacao_nome() and self.validacao_preco():
            ...
            # atribuir o texto à label de dados inseridos entre o botao e a tabela
            self.mensagem['text'] = 'Produto {} adicionado com exito'.format(self.nome.get())
        ...
        # depois de finalizar a inserção dos dados atualizar o conteudo da tabela
        self.get_produtos()
    ...
    def edit_produto(self):
        ...
        # Janela Nova para editar produto:
        ...
        self.janela_editar.wm_iconbitmap('recursos/M6_p2_icon.ico')  # Ícone da janela
        ...
        frame_ep = LabelFrame(self.janela_editar, text="Editar o seguinteProduto", font=('Calibri', 16, 'bold')
...
if __name__ == '__main__':
    ...
    app = Produto(root)  # Envia-se para a class Produto o controlo sobre a janela root
    root.mainloop()  # Começamos o ciclo da aplicação. é como um while loop
